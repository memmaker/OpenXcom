...
public:
	...
	const std::vector<std::string>& getCompatibleWeapons() const { return _compatibleWeapons; }
	/// Gets the list of required soldier bonuses for this skill.
	const std::vector<std::string>& getRequiredBonuses() const { return _requiredBonuses; }
